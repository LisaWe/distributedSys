 ...
 * {@linkplain InterruptedException}; note the infectious spreading of {@code InterruptedException}
 * declarations once one has been declared by an operation! There are two rules which must always be
...
public final class ResyncThreadByFuture2 {
	 ...
	 */
	static public void main (final String[] args) throws ExampleWorkerException, InterruptedException {
	 ...
	 * @throws InterruptedException if this operation is interrupted
	 */
	static private void resync (final int childThreadCount, final int maximumWorkDuration) throws ExampleWorkerException, InterruptedException {
